...
while(loop_flag):
    serial_data = str(chr(int(getComVal(b"15", 3))))
    serial_data = str(chr(int(getComVal(b"41", 3000))))
    time.sleep(1)
    turnOffDevice()
    time.sleep(5)
    #loop_flag = menu()
    #serial_data = str(chr(int(getComVal(b"15", 2))))
   # time.sleep(30)
    #serial_data = str(chr(int(getComVal(b"41", 250))))
    
    #time.sleep(5)
   # serial_data = str(chr(int(getComVal(b"41", 0))))
